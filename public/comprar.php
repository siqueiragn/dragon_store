...
if($_SESSION['autenticado'] != 'OK')
	...
	$Vai		.= "\nOs produtos vao ser entregues em ate 30 dias para o seguinte CEP: ". $_SESSION['cep'];
	$Vai		.= "\nNo seguinte endereço: ".$_SESSION['rua'].', '.$_SESSION['cidade'].' - '.$_SESSION['bairro'];
	$Vai		.= "\n".$_SESSION['complemento'];
	$Vai		.= "\n\n \n\nA Dragon Store agradece sua preferencia.";
