    ...
    <div class="form-inline my-2 my-lg-0">
			<form class="form-inline my-2 my-lg-0" action="resultado.php"
				...
				<input class="form-control mr-sm-2" name="pesquisa" type="text"
					...
					class="btn btn-outline-success my-2 my-sm-0" value="Listar"
					type="submit">
...
echo "<img class='rounded-circle' src='img/" . $line ['foto'] . "'alt='Imagem' width='140' height='140'/>";
	...
	<footer>
		<div class="text-center">
			<p>
				<a href="http://canoas.ifrs.edu.br">2017 - IFRS Campus Canoas</a>
			</p>
